...
public class Deck
	{
		...
		public static ArrayList<Card> temp = new ArrayList<Card>();
		public static ArrayList<Card> testRoyalFlushDuplicates = new ArrayList<Card>();
		public static ArrayList<Card> royalFlush = new ArrayList<Card>();
		...
		public static void fillTestRoyalFlushDuplicates()
			{
				testRoyalFlushDuplicates.add(new Card("Ace", "Hearts", 14));
				testRoyalFlushDuplicates.add(new Card("King", "Clubs", 13));
				testRoyalFlushDuplicates.add(new Card("Ace", "Spades", 14));
				testRoyalFlushDuplicates.add(new Card("Ten", "Hearts", 10));
				testRoyalFlushDuplicates.add(new Card("King", "Spades", 13));
				testRoyalFlushDuplicates.add(new Card("Queen", "Diamonds", 12));
				testRoyalFlushDuplicates.add(new Card("Ten", "Diamonds", 10));

			}

		public static void fillRoyalFlush()
			{
				royalFlush.add(new Card("Ace", "Hearts", 14));
				royalFlush.add(new Card("King", "Hearts", 13));
				royalFlush.add(new Card("Queen", "Hearts", 12));
				royalFlush.add(new Card("Jack", "Diamonds", 11));
				royalFlush.add(new Card("Jack", "Hearts", 11));
				royalFlush.add(new Card("Ten", "Hearts", 10));
				royalFlush.add(new Card("Five", "Spades", 5));
			}
	}